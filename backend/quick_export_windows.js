...
console.log('🚀 EXPORT RAPIDE DE LA BASE DE DONNÉES RH_PORTAL (Windows)');
console.log('============================================================');
...
// Commande d'export compatible Windows
const command = `set PGPASSWORD=${DB_CONFIG.password} && pg_dump -h ${DB_CONFIG.host} -U ${DB_CONFIG.user} -d ${DB_CONFIG.database} -p ${DB_CONFIG.port} --no-owner --no-privileges --clean --create --if-exists > "${filepath}"`;
