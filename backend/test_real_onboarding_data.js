...
async function testRealOnboardingData() {
  try {
    console.log('🔍 Test avec les vraies données d\'onboarding...\n');
    ...
    console.log('\n📋 Tentative d\'insertion avec les vraies données...');
