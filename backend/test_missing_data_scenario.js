...
async function testMissingDataScenario() {
  try {
    console.log('🔍 Test avec des données manquantes...\n');
    
    // Simuler des données avec des valeurs manquantes (comme dans le vrai onboarding)
    const employeeData = {
      ...
      date_fin_contrat: undefined, // Valeur manquante
      salaire_base: undefined, // Valeur manquante
      salaire_propose: undefined, // Valeur manquante
      source_recrutement: undefined, // Valeur manquante
      categorie: 'Cadre',
      responsable: undefined, // Valeur manquante
      niveau_etude: 'Bac+5',
      specialisation: 'Informatique',
      type_remuneration: undefined, // Valeur manquante
      mode_paiement: undefined, // Valeur manquante
      periode_essai: undefined, // Valeur manquante
      date_fin_essai: undefined, // Valeur manquante
      lieu_travail: undefined, // Valeur manquante
      horaires_travail: undefined, // Valeur manquante
      date_signature: undefined, // Valeur manquante
      conditions_particulieres: undefined, // Valeur manquante
      avantages_sociaux: undefined, // Valeur manquante
      notes: undefined // Valeur manquante
    };
    
    const newEmployee = { id: 1 }; // Simuler un employé existant
    
    console.log('📋 Données avec valeurs manquantes:', JSON.stringify(employeeData, null, 2));
    
    // Test avec des données manquantes
    if (employeeData.type_contrat && employeeData.date_entree) {
      console.log('\n📋 Tentative d\'insertion avec données manquantes...');
      ...
      console.log('✅ Insertion réussie même avec données manquantes !');
