...
13. [Documents et Rapports](#documents-et-rapports)
14. [Dépannage et Support](#dépannage-et-support)
...
- **Permissions** : Consultation, demandes de congés
- **URL** : `/EmployeeLogin`
...
2. **Sélectionner le type de connexion** (Admin RH, Employé, Médecin)
...
### Vue d'ensemble
Le tableau de bord offre une vision complète de l'état de l'organisation avec des indicateurs clés.

### Widgets disponibles

#### 1. Statistiques Employés
- **Effectif total** : Nombre d'employés actifs
- **Nouveaux embauches** : Employés récemment recrutés
- **Départs** : Employés partis récemment
- **Taux de rotation** : Pourcentage de rotation du personnel

#### 2. Alertes et Notifications
- **Contrats à renouveler** : Contrats arrivant à expiration
- **Congés en attente** : Demandes de congés à traiter
- **Absences non justifiées** : Absences nécessitant un suivi

#### 3. Graphiques et Tendances
- **Évolution des effectifs** : Graphique temporel
- **Répartition par département** : Camembert des services
- **Taux de présence** : Statistiques de présence

### Actions rapides
- **Ajouter un employé** : Accès direct au formulaire
- **Gérer les congés** : Traitement des demandes
- **Créer un événement** : Planification d'événements
...
- Aller dans **Gestion des Employés** → **Ajouter un Employé**
- Ou utiliser le bouton "Ajouter un Employé" du tableau de bord

#### 2. Informations personnelles
- **Nom et prénom** : Saisir le nom complet
...
- **Niveau d'étude** : Diplôme le plus élevé
- **Spécialisation** : Domaine d'expertise
- **Université** : Établissement de formation

#### 5. Informations financières
- **Salaire de base** : Rémunération de base
- **Salaire net** : Salaire après déductions
- **Type de rémunération** : Mensuel, horaire, etc.
- **Mode de paiement** : Virement, chèque, etc.

#### 6. Documents requis
- **CV** : Curriculum vitae
- **Lettre de motivation** : Motivation du candidat
- **Copie de la pièce d'identité** : Carte nationale, passeport
- **Diplômes** : Copies des diplômes obtenus
- **Contrat de travail** : Document contractuel

### Gérer les employés existants

#### 1. Consultation de la liste
- Aller dans **Gestion des Employés** → **Effectif**
- Utiliser les filtres pour rechercher un employé spécifique
- Trier par nom, département, date d'embauche

#### 2. Consultation des détails
- Cliquer sur l'icône "œil" pour voir les détails
- Modal avec toutes les informations de l'employé
- Onglets organisés par catégorie d'information
...
- L'employé est archivé dans l'historique

### Historique et suivi

#### 1. Historique de recrutement
- Suivi des candidatures
- Statut des processus de recrutement
- Notes et évaluations des candidats

#### 2. Historique de départ
- Raisons de départ
...
- Aller dans **Gestion des Congés** → **Congés**
- Cliquer sur "Nouvelle demande de congé"
- Remplir le formulaire :
  - **Employé** : Sélectionner l'employé concerné
...
- **Statut "En attente"** : Demande soumise
- **Statut "Approuvé"** : Congé validé
- **Statut "Refusé"** : Congé rejeté avec motif

#### 3. Calcul automatique
- **Jours pris** : Calculé automatiquement
- **Jours restants** : Mise à jour automatique
- **Date de prochaine attribution** : Calculée selon la politique

### Gestion des absences

#### 1. Déclarer une absence
- Aller dans **Gestion des Congés** → **Absences**
- Cliquer sur "Nouvelle absence"
- Remplir le formulaire :
  - **Employé** : Sélectionner l'employé
  - **Type d'absence** : Maladie, accident, grève, etc.
  - **Date de début** : Date de début de l'absence
  - **Date de fin** : Date de fin de l'absence
  - **Motif** : Raison détaillée
  - **Rémunération** : Impact sur la paie

#### 2. Suivi des absences
- **Statut** : En attente, Validée, Refusée
- **Justificatif** : Document de justification
- **Impact salarial** : Calcul des retenues
...
#### 1. Accès au formulaire
- Aller dans **Gestion des Employés** → **Contrats**
...
#### 1. Accès au formulaire
- Aller dans **Événements** → **Ajouter événement**
- Ou utiliser le bouton "Nouvel Événement" du tableau de bord

#### 2. Informations de l'événement
- **Nom de l'événement** : Titre de l'événement
...
- **Nouvelle candidature** : Enregistrer un candidat
- **Statut** : En attente, En cours, Acceptée, Refusée
- **Notes** : Évaluations et commentaires

#### 2. Entretiens
- **Planification** : Fixer date et heure
- **Participants** : RH, responsable, candidat
- **Évaluation** : Grille d'évaluation
- **Décision** : Acceptation ou refus

### Onboarding

#### 1. Accueil du nouvel employé
- **Présentation de l'entreprise** : Culture, valeurs, organisation
- **Formation** : Procédures, outils, systèmes
- **Intégration** : Rencontre avec l'équipe
...
- **Entretien de sortie** : Bilan et feedback
- **Récupération des biens** : Badges, équipements
- **Documents de fin** : Certificat de travail, attestation
...
- **Informations personnelles** : Nom, prénom, nationalité
- **Diplômes** : Formation médicale
- **Documents requis** : Pièces d'identité, diplômes
...
#### 1. Planification des visites
- **Fréquence** : Selon la réglementation
- **Type** : Embauchage, périodique, reprise
- **Médecin** : Médecin du travail

#### 2. Suivi des résultats
- **Aptitude** : Apte, inapte temporaire, inapte définitive
...
- **Répartition** : Distribution par catégorie
